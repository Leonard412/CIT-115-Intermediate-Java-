 ...
 * @(#)Exceptions.java
 *
 * Basic code related to exceptions.
 * Show fils I/O for Binary and Text files.
 *
 * The file input output is handled by classes for text and binary.
 * These classes do not have to be made but just make coding a little easier.
 *
